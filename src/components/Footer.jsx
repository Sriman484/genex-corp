...
function Footer() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!email) {
      ...
      alert("Form submitted successfully!"); // Or handle your form submission logic here
    }
  };
    ...
    <footer className="bg-gray-50 text-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 py-2 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-600 leading-normal">
            Empowering businesses through innovative technology and a human
            touch.
          </p>
          <div className="flex space-x-3">
            {socialLinks.map(({ href, icon: Icon, color }, index) => (
              <a
                ...
                className={`text-gray-600 transition-colors ${color}`}
              >
                <Icon size={24} />
              </a>
            ))}
        ...
        <div>
          ...
          <div className="space-y-3 text-sm text-gray-600">
            <div className="flex items-start">
              ...
              <span>
                VT Plaza, 4th Floor, KPHB Colony, Kukatpally, Hyderabad, India
              </span>
            </div>
        ...
        <div>
          ...
          >
            <input
              ...
              } rounded px-3 py-1.5 text-sm text-gray-800 focus:outline-none focus:ring-2 ${
      ...
      <div className="border-t border-gray-300 py-1 text-xs">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-gray-500">
          <span>
            &copy; {new Date().getFullYear()} Genexcorp. All rights reserved.
          </span>
          <button
            onClick={scrollToTop}
